<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Feed.aspx.cs" Inherits="ICT4Events_WebApplication.Feed" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr><td><asp:Label cssclass="Label3" runat="server" Text="Pad:"></asp:Label></td><td><asp:FileUpload id="FileUploadControl" runat="server" style="Width: 290px;" /><asp:TextBox cssclass="tbPad" runat="server" Width="200px" ID="tbPad"></asp:TextBox>
            <asp:Button cssclass="btBrowse" runat="server" Height="30px" Text="Uploaden" Width="85px" BackColor="#6E5A7A" ID="btBrowse" OnClick="btBrowse_Click"/>
            </td></tr>
    ...
    <div id="sorteermenu">
        ...
        <div id="likemenu" style="clear:both;"><asp:Label ID="lbidentificeer" runat="server" Text=""></asp:Label><asp:TextBox ID="tbIdentificeer" runat="server" ReadOnly="True"></asp:TextBox><asp:Button ID="like" CssClass="btBrowse" runat="server" Text="Like!" OnClick="like_Click1" /><asp:Button ID="ongewenst" CssClass="btBrowse" button="button" runat="server" Text="Report" /></div>
    </div>
    <div id="feed">
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataSourceID="GetFeed" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField HeaderText="gebruikersnaam" DataField="gebruikersnaam" SortExpression="gebruikersnaam" />
                <asp:BoundField HeaderText="bijdrage_id" DataField="bijdrage_id" SortExpression="bijdrage_id" />
        ...
        <asp:SqlDataSource ID="GetFeed" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;ACCOUNT&quot;.&quot;gebruikersnaam&quot;, BERICHT.&quot;bijdrage_id&quot;, BERICHT.&quot;titel&quot;, BERICHT.&quot;inhoud&quot;, BIJDRAGE.&quot;datum&quot;, BIJDRAGE.&quot;soort&quot;, BIJDRAGE.&quot;like&quot;, BIJDRAGE.&quot;ongewenst&quot; FROM BERICHT, BIJDRAGE, &quot;ACCOUNT&quot; WHERE BERICHT.&quot;bijdrage_id&quot; = BIJDRAGE.ID AND BIJDRAGE.&quot;account_id&quot; = &quot;ACCOUNT&quot;.ID"></asp:SqlDataSource>
        <label for="FileUpload2">Download een bestand!</label><asp:FileUpload id="FileUpload2" runat="server" /><asp:Button ID="btdownload" CssClass="btBrowse" runat="server" Text="Download" />
